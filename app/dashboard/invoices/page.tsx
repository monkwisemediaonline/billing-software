    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="page-anim" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "32px" }}>
        ...
        <Link href="/dashboard/invoices/new" style={{
          ...
          color: "white", borderRadius: "12px", padding: "11px 22px",
          fontWeight: "700", display: "flex", alignItems: "center", gap: "8px",
          textDecoration: "none", boxShadow: "0 4px 15px rgba(217,70,239,0.35)",
          fontSize: "14px",
        }}>
      ...
      <div className="page-anim" style={{
        ...
        <input
          ...
          style={{
            ...
            color: txt(0.9), fontSize: "14px", width: "100%",
          }}
        />
      </div>
      ...
      <div className="page-anim" style={{
        ...
        boxShadow: "0 8px 32px rgba(139,92,246,0.1)", overflow: "hidden",
        animationDelay: "0.1s",
      }}>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ background: "rgba(139,92,246,0.05)" }}>
              {["Invoice", "Client", "Date", "Amount", "Due", "Status", "Action"].map((h) => (
                <th key={h} style={{
                  padding: "14px 20px", textAlign: "left",
                  fontSize: "11px", fontWeight: "700", letterSpacing: "0.08em",
                  textTransform: "uppercase", color: txt(0.4),
          ...
          <tbody>
            {filtered.map((inv, i) => (
              <tr key={inv.id} className="row-hover" style={{
                borderBottom: i < filtered.length - 1 ? "1px solid rgba(139,92,246,0.06)" : "none",
              }}>
                ...
                <td style={{ padding: "16px 20px" }}>
                  <Link href={`/dashboard/invoices/${inv.id}`} className="view-btn" style={{
